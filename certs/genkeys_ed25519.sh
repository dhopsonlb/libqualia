...
openssl genpkey -algorithm ed25519 -out server_privkey.pem
openssl req -new -key server_privkey.pem -out server_privkey.csr
openssl x509 -req -in server_privkey.csr -CA ca_root.pem -CAkey ca_privkey.pem -CAcreateserial -out cert.pem -days 5000 -sha512
