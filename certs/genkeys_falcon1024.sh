...
openssl genpkey -algorithm falcon1024  -out privkey.pem -provider oqsprovider 
openssl req -new -key privkey.pem -out privkey.csr -provider oqsprovider
openssl x509 -req -in privkey.csr -CA ca_root.pem -CAkey ca_privkey.pem -CAcreateserial -out cert.pem -days 5000 -sha512 -provider oqsprovider
